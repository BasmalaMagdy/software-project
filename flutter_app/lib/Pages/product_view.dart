...
https://github.com/BasmalaMagdy/software-project
      ...
      appBar: new AppBar(
        ...
        actions: <Widget>[
          ...
          new IconButton(
              ...
              onPressed: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => new Cart())); //cart.dart linker
              })
        ],
      ),
      //dropdown list
          ...
          Row(
            children: <Widget>[
              ...
              new IconButton(
                  ...
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) => Product(product: widget.product)));
                  }),
