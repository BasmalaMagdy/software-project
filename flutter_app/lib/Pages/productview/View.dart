...
class _ViewBodyState extends State<ViewBody> {
  ...
  Widget build(BuildContext context) {
    final List<CommentData> comments = Provider.of<List<CommentData>>(context);
    //context.watch<List<CommentData>>();
    if (comments != null && comments.isNotEmpty)
      avg = avgRating(comments);
    else
      avg = 0;
...
//====================rating==============================
                ...
                new Row(children: <Widget>[
                  SmoothStarRating(
                    starCount: 5,
                    isReadOnly: true, // can changr rating or not
                    spacing: 2,
                    rating: avg,
                    size: 30,
                                ...
                                new Row(
                                  children: <Widget>[
                                    SmoothStarRating(
                                      starCount: 5,
                                      isReadOnly:
                                          false, // can changr rating or not
                                      spacing: 2,
                                      rating: 4,
                                      size: 30,
                                      color: Colors.yellow[700],
